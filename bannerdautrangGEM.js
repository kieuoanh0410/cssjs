...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='https://canhothuongmai24h.blogspot.com/' target='_blank'><img src='//please contact me giaiphapthuonghieu.org@gmail.com
//website http://giaiphapthuonghieu.vn or http://faceseo.vn
...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$(divpopup).attr('class', 'linhnguyen-modal');
			$( "body" ).append(divpopup);
			$("#myModal").html("<a href='https://canhothuongmai24h.blogspot.com/' target='_blank'><img src='https://3.bp.blogspot.com/-ZN_rWGDkt4Y/W2K8qE4XndI/AAAAAAAALNk/F8gn8ZiNKYUbVDUwHcXqhWw2aeIcuIUlACLcBGAs/s640/Untitled-1.jpg' width='500px'/><br/>Bảng giá MỚI NHẤT Gem Quận 2</a>. Liên hện ngay: 0934765209. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
			$('#myModal').linhnguyen($('#myModal').data());
		}
});' width='500px'/><br/>Căn hộ Officetel Quận 7</a>. Hotline: 0934765209. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
			$('#myModal').linhnguyen($('#myModal').data());
		}
});
